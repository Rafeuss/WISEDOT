...
Usei IA ao longo do projeto para tirar dúvidas, montar specs e documentos, e ordenar e padronizar a forma que a documentação é escrita. Também usei IA para revisar e elaborar a documentação de correção e para corrigir os erros de código — nesses casos, o processo foi primeiro levantar cada ponto do retorno recebido, eu aprovar o que fazia sentido corrigir, para só depois a IA aplicar a correção no código e nos documentos.
